...
contract ZoraTimedSaleStrategyConstants {
    ...
    uint256 internal constant CREATOR_REWARD = 0.0000000555 ether;
    /// @notice The mint referrer reward
    uint256 internal constant MINT_REFERRER_REWARD = 0.0000000222 ether;
    /// @notice The creator referrer reward
    uint256 internal constant CREATOR_REFERRER_REWARD = 0.0000000111 ether;
    ...
    uint256 internal constant MARKET_REWARD = 0.0000000111 ether;
    /// @notice The Zora reward
    uint256 internal constant ZORA_REWARD = 0.0000000111 ether;
    /// @notice 1e18
